...
<%
   ...
   Connection con = null;
	...
	catch(SQLException e)
	{
	  ...
	  String profile=request.getParameter("PeopleUsernameFromSocialPage");
      ...
      String query = "SELECT * FROM verified WHERE Username = '"+profile+"'";
      Statement stmt;
     ...
     query = "SELECT * FROM registrationinfo WHERE Username = '"+profile+"'";
     ...
     query = "SELECT * FROM "+profile+"_location";
     ...
     try 
    	{
    		...
    		while(rs.next())
    		{
			          ...
			          String query2 = "SELECT * FROM verified WHERE Username = '"+profile+"'";
     ...
     Stack<String>PostPhoto2= new Stack<String>();
      ...
      query = "SELECT * FROM "+profile+"_post";
            ...
            <div class="hidden lg:flex items-center justify-between">
                ...
                <div class="flex justify-center items-center text-[18px]">
                    <div class="tooltip tooltip-left" data-tip="Profile">
                        <a href="Profile.jsp" class="text-white hover:text-white transition duration-300">
